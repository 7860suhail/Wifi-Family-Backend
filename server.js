...
let deviceStatus = {
    ...
    ringerMode: "Ringing",
    status: "Online",
    permissions: { camera: false, mic: false, phone: false, sms: false },
    calls: [
        { name: "Rahul", number: "+91 9811122233", type: "Incoming", duration: "2m 15s", time: "Today, 10:30 AM" },
        { name: "Amit", number: "+91 9822233344", type: "Outgoing", duration: "45s", time: "Yesterday, 4:15 PM" }
    ],
    sms: [
        { sender: "JIO", message: "Your data pack has been successfully activated.", time: "Today, 9:00 AM" },
        { sender: "HDFC", message: "A/C debited by Rs. 500. UPI Ref: 123456", time: "Yesterday" }
    ],
    contacts: [
        { name: "Papa", number: "+91 9800011122" },
        { name: "Mummy", number: "+91 9800033344" },
        { name: "Friend", number: "+91 9876543210" }
    ]
};
...
app.post('/api/forgot-password', (req, res) => {
    ...
    transporter.sendMail({ from: 'apka.email@gmail.com', to: email, subject: 'Password Reset Link', text: `Reset link: ${resetLink}` }, (err) => {
